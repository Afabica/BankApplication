...
//import { getExchangeRates } from "./getExchangeRates"; // Import the function from the previous example
//
...
//      const data = await getExchangeRates("USD"); // Fetching exchange rates with USD as the base currency
